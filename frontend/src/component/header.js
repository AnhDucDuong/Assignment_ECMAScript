                                ...
                                <div class="group relative">
                                    ...
                                    <div class="absolute right-0 bg-gray-300 w-max border border-gray-400 mt-14 opacity-0 invisible group-hover:opacity-95 group-hover:visible group-hover:mt-0 transition-all duration-500">
                                        <div class="bg-white max-w-sm py-4 px-5 rounded shadow-2xl text-gray-800">
                                            ...
                                            <form action="" class="mt-4 pt-2 relative mx-auto text-gray-600">
                                                <div class="mb-6">
                                                    <label for="email" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Email</label>
                                                    <input type="email" name="email" id="email" placeholder="you@company.com" class="w-80 px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" />
                                                </div>
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <input type="password" name="password" id="password" placeholder="Your Password" class="w-80 px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" />
                                                </div>
