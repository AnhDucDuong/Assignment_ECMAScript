            ...
            <section class="text-gray-600 body-font overflow-hidden">
                <div class="px-36 py-8 mx-auto">
                    ...
                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <h2 class="text-sm title-font text-gray-500 tracking-widest">Số lượng: ${product.quantity}</h2>
                        <div class="flex mb-4">
                        ...
                        <div class="flex mt-6">
                            ...
                            <button id="add-to-cart" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Mua ngay</button>
