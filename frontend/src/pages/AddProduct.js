                    ...
                    <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
                        ...
                        <nav class="mt-10">
                            ...
                            <a class="flex items-center mt-4 py-2 px-6 bg-gray-700 bg-opacity-25 text-gray-100"
                                ...
                                <span class="mx-3">Thêm sản phẩm</span>
                            </a>
                    ...
                    <div class="flex-1 flex flex-col overflow-hidden">
                        ...
                        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                            <div class="container mx-auto px-6 py-8">
                                ...
                                <form id="form-add" class="mt-10 ml-6">
                                    <h5 class="mb-2 text-xl font-semibold">Tên sản phẩm:</h5>
                                    <input class="w-1/2 h-8 mb-6 focus:outline-none border border-gray-400 rounded-sm pl-2" type="text" placeholder="Tên sản phẩm" id="product-name">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <a href="" class="bg-indigo-600 px-4 py-2 text-white rounded-md ml-2">Danh sách</a>
                                    </div>
                                </form>
                            </div>
                        </main>
